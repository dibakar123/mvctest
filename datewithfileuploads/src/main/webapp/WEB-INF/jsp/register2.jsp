...
<div class="column side2">
	...
	<form:form id="regForm" modelAttribute="user" action="registerProcess2.do" method="post" enctype="multipart/form-data">
		...
		<table align="center">
			...
			<tr>
				...
				<input type="file" name="file" id="address_fname"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type="file" name="file" id="dob_fname"></td>
			</tr> 
			<tr>
